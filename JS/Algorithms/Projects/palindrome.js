...
function palindrome(str) {
    // Create a regex matching everything except alpha-numeric values
    const nonAlphaRegex = /\W|_/g;
    // Format the string by removing spaces, case and non-alphanumeric characters
    const formattedStr = str.replace(nonAlphaRegex, '').toLowerCase();
    // Reverse the string
